...
var checkStatus = function checkStatus(response) {
    if (response.ok) {
        // .ok will return true if status = 200-299
        return response;
    }
    throw new Error('Error status either 404 or 500');
};
...
var ToDoList = function (_React$Component) {
    ...
    _createClass(ToDoList, [{
        ...
        value: function fetchTasks() {
            ...
            fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1269").then(checkStatus).then(json).then(function (response) {
        ...
        value: function handleSubmit(event) {
            ...
            fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1269", {
                method: "POST",
                mode: "cors",
        ...
        value: function deleteTask(id) {
            ...
            fetch('https://fewd-todolist-api.onrender.com/tasks/' + id + '?api_key=1269', {
                method: "DELETE",
                mode: "cors"
            }).then(checkStatus).then(json).then(function (data) {
                _this4.fetchTasks(); //update list after delete
            }).catch(function (error) {
        ...
        value: function toggleComplete(id, completed) {
            ...
            fetch('https://fewd-todolist-api.onrender.com/tasks/' + id + '/mark_' + newState + '/?api_key=1269', {
                method: 'PUT',
                mode: 'cors'
            }).then(checkStatus).then(json).then(function (data) {
                _this5.fetchTasks();
                    ...
                    React.createElement(
                        ...
                        tasks.length > 0 ? tasks.filter(function (task) {
                            if (filter === 'all') {
                                ...
                                return !task.completed; //task.active
                            } else {
